  ...
  function enterAnimation(e) {
    return new Promise(async (resolve) => {
      await tl
        ...
        .then();
      resolve();
  jQuery("span:nth-child(1)").toggleClass('top-nav-bar');
      jQuery("span:nth-child(2)").toggleClass('fade');
    jQuery("span:nth-child(3)").toggleClass('bottom-nav-bar');
   
      jQuery('nav').toggleClass('open');
  jQuery('#site-logo').css('transform', 'translateX(0)');
  jQuery(".nav-trigger").css('transform', 'translateX(0)');
  jQuery(".main-fluid").css('transform', 'translateX(0)');
    });
